...
| `github-only-attestations` | forgejo, gitea | error | `actions/attest*` (`actions/attest-build-provenance`, `actions/attest-sbom`, `actions/attest`) | [Gitea token permissions](https://docs.gitea.com/usage/actions/token-permissions#compatibility-notes), [attest-build-provenance](https://github.com/actions/attest-build-provenance) |
